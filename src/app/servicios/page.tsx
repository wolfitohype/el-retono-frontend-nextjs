...
const servicios: Servicio[] = [
    ...
    {name: 'Venta e instalación de pasto', imageUrl: '/servicios-media/pasto.webp', link: '/pasto-tampico-madero-altamira'},
...
function Page() {
    return (
        <>
            <div className="h-fit w-dvw flex flex-col items-center justify-center space-y-8">
