...
function ServiciosCard({imageUrl, servicio, link}: ServiciosCardProps) {
    return (
        <Link href={`/servicios${link}`} className="border-gray-100 border overflow-hidden rounded-md drop-shadow-md hover:shadow-xl active:shadow-xl cursor-pointer transition-all duration-300 flex relative h-64 w-3/4 md:h-70">
            ...
            <div className="bg-white w-full bottom-0 absolute text-xl z-10 py-3 px-4 space-y-2">
